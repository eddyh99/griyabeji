	...
	table = $('#table_data').DataTable({
		    ...
		    "aoColumnDefs": [{	
				...
				"mRender": function (data, type, full, meta){
					...
					button=button+'<a href="<?=base_url()?>guide/DelData/'+encodeURI(btoa(full.id))+'" class="del-data btn btn-simple btn-danger btn-icon remove rounded-circle mx-1"><i class="material-icons fs-3">close</i></a>';
					return button;
				    // if (full.role!="Admin"){
