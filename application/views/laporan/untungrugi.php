        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="row my-10 justify-content-center">
                ...
                <div class="col-lg-10 card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>laporan/untungrugi/" method="get">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="col-2 text-end pe-10"><a href="<?= base_url() ?>laporan/detailuntungrugi/<?= base64_encode($pj['id']) ?>" class="btn btn-sm btn-info">Detail</a></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                            <tfoot>
